      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div className="relative">
          <div className="relative">
            ...
            <Label
              ...
              className={`absolute left-4 text-gray-400 transition-all duration-200 pointer-events-none ${
                confirmPasswordFocused ? "text-xs top-2" : "top-1/2 -translate-y-1/2"
              }`}
            >
              Confirm Password
            </Label>
        ...
        <div className="flex items-start space-x-2">
          <Checkbox
            ...
            className="border-gray-600 data-[state=checked]:bg-[#e50914] data-[state=checked]:border-[#e50914] mt-1"
          />
